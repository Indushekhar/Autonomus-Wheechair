...
if("TRUE" STREQUAL "TRUE")
  set(mybot_description_SOURCE_PREFIX /home/indushekhar/project5_ws/src/mybot_description)
  set(mybot_description_DEVEL_PREFIX /home/indushekhar/project5_ws/devel)
  ...
  set(mybot_description_INSTALL_PREFIX /home/indushekhar/project5_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/indushekhar/project5_ws/src/mybot_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/indushekhar/project5_ws/devel/lib;/home/indushekhar/ws_baxter/devel/lib;/opt/ros/kinetic/lib)
